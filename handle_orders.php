...
<html>
    <head>
        <title>
            Handle Orders | ABC Builders & Suppliers
        </title>
        <link rel="stylesheet" href="./styles/main.css">
    </head>
    <body>
        <hr />
        <h1 id="header" style="text-align: left; margin: auto 0px; padding: 10px;">Handle Orders<br />ABC Builders & Suppliers</h1>
        <hr />
        ...
        <a style="margin-left: 4px;" href="./index.php">Home</a>
            ...
            <?php
                if ($is_admin === true) {
                    echo "<a href=\"admin_panel.php\">Admin</a> <a class='active' href=\"handle_orders.php\">Orders</a>";
                }
                elseif(isset($role)){
        ...
        <section>
            ...
            <a href="#completed" class="add_mat_link" style="display: <?php echo $display_msg; ?>">You have completed all the orders!</a>
                            ...
                            while ($row = $result -> fetch_assoc()){
                                ...
                                echo '
                                    <tr>
                                        ...
                                        <td>'.$material_name.'</td>
                                        <td>'.$quantity.'</td>
                                        <td style="text-align: center;"><a href="./process/complete_orders.php?id='.$order_id.'" class="update_mat_link">Processed</a></td>                                        
                                    </tr>
                                ';
                            }
                    }
        ...
        <h2 class="header_2" id="completed">Currently Delivering Orders</h2>
...
<section>
    ...
    <a href="#not_completed" class="add_mat_link" style="display: <?php echo $display_msg; ?>">Currently, no order is in the delivery!</a>
